  ...
  return (
    <div className="flex flex-col gap-8">
      <section className="flex flex-col justify-between gap-5 md:flex-row md:items-end">
        <div><p className="mb-3 font-mono text-[10px] uppercase tracking-[0.22em] text-[#c06f43]">Operations / {new Date().toLocaleDateString(undefined, { month: "long", day: "numeric" })}</p><h1 className="font-display text-4xl font-bold tracking-tight text-[#173b3a] md:text-5xl">Good morning.</h1><p className="mt-3 max-w-xl text-sm leading-relaxed text-[#71807a]">Your evidence workspace is clear. Review the latest activity or continue with an authorized case file.</p></div>
