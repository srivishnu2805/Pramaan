...
async def list_case_documents(
    ...
    result = await session.execute(
        select(Document)
        .where(scope.document_filter(), Document.case_id == case_id)
...
@router.get(
    "/documents/{document_id}/versions/{version_number}/verify", response_model=IntegrityOut
)
